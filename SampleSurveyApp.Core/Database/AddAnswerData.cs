	...
	public class AddAnswerData
	{
        ...
        public AddAnswerData(IAsyncRepository<SurveyAnswerModel> surveyAnswerModelRepository)
        {
            ...
            SurveyAnswerList = new List<SurveyAnswerModel>()
            {
                ...
                new SurveyAnswerModel () { QCode = 5, ACode = 1, AText = "Option 1", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 2, AText = "Option 2", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 3, AText = "Option 3", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 4, AText = "Option 4", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 5, AText = "Option 5", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 6,AText = "Option 6", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 7, AText = "Option 7", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 8, AText = "Option 8", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 9, AText = "Option 9", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 10, AText = "Option 10", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 11, AText = "Option 11", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 12, AText = "Option 12", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 13, AText = "Option 13", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 14,AText = "Option 14", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 15, AText = "Option 15", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 16, AText = "Option 16", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 17,AText = "Option 17", RuleType = -1},
                new SurveyAnswerModel () { QCode = 5, ACode = 18, AText = "Option 18", RuleType = -1},
